...
from leapp.models import Report, InstalledUnsignedRPM
from leapp.tags import IPUWorkflowTag, ChecksPhaseTag
from leapp.reporting import report_generic, report_with_remediation
...
class RedHatSignedRpmCheck(Actor):
    ...
    def process(self):
        ...
        if len(unsigned_pkgs.items):
            ...
            report_with_remediation(title='Packages not signed by Red Hat found in the system', 
